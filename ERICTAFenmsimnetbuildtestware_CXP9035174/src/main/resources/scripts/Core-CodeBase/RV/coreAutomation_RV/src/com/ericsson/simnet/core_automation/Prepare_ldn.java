...
public class Prepare_ldn {
	...
	public ArrayList<String> get_moid(ArrayList<String> Parent_line, ArrayList<String> index_line, ArrayList<String> MO_type) 
	{
		//String Parent_Line="parent \"SgsnMmeTop:ManagedElement=SGSN-15A-WPP-V401,SgsnMmeTop:SystemFunctions=1,SgsnMmeBRM:BrM=1\"";
		...
		else if(cnt==0)
		{
			...
			Parent_Required=Parent_Line.substring(Parent_Line.indexOf(':'),Parent_Line.indexOf('"'));
		...
		while(cnt>0)
			{
				...
				{
					Parent_Required=Parent_Required+Parent_Line.substring(Parent_Line.indexOf(':'),Parent_Line.indexOf(','));
					Parent_Required=Parent_Required.substring(1);		
				}
				else
				{	
					P3=Parent_Line.substring(Parent_Line.indexOf(':'),Parent_Line.indexOf(','));
					Parent_Required=Parent_Required+","+P3.substring(1);
				}
				Parent_Line=Parent_Line.substring(Parent_Line.indexOf(','));
				Parent_Line=Parent_Line.substring(1);
				cnt=cnt-1;
			}
		P3=Parent_Line.substring(Parent_Line.indexOf(':'),Parent_Line.indexOf('"'));
	...
	public ArrayList<String> get_moid_Kertyle(ArrayList<String> Parent_line, ArrayList<String> index_line, ArrayList<String> MO_type) 
	{
		//String Parent_Line="parent \"SgsnMmeTop:ManagedElement=SGSN-15A-WPP-V401,SgsnMmeTop:SystemFunctions=1,SgsnMmeBRM:BrM=1\"";
		//String Index_Line="identity \"1\"";
		//String MO_Type="moType SgsnMmeBRM:BrmBackupManager";
