...
public class get_child_count_of_MOs {
	...
	public ArrayList<Integer> get_count_MOs(ArrayList<String> MO_Child, ArrayList<String> MO_Parent)
	{
...
//MO_Parent.add("a");MO_Parent.add("a");	MO_Parent.add("b");MO_Parent.add("b");MO_Parent.add("n");MO_Parent.add("c");	MO_Parent.add("c");	MO_Parent.add("d");	MO_Parent.add("d");	MO_Parent.add("e");	MO_Parent.add("e");	MO_Parent.add("f");	MO_Parent.add("f");	MO_Parent.add("r");	MO_Parent.add("t");MO_Parent.add("t");	MO_Parent.add("g");	MO_Parent.add("g");	MO_Parent.add("i");	MO_Parent.add("j");	MO_Parent.add("j");	MO_Parent.add("l");MO_Parent.add("v");MO_Parent.add("v");	
					...
					if(MO_Child.get(j).equals(MO_Parent.get(k)))
					{
						...
						for(int l=0;l<MO_Parent.size();l++)
						{
							if(MO_Child.get(k).equals(MO_Parent.get(l)))
							{
								...
								{
									if(MO_Child.get(l).equals(MO_Parent.get(m)))
									{
										Count =Count+1;
										for(int n=0;n<MO_Parent.size();n++)
										{
											if(MO_Child.get(m).equals(MO_Parent.get(n)))
											{
												Count =Count+1;
												for(int o=0;o<MO_Parent.size();o++)
												{
													if(MO_Child.get(n).equals(MO_Parent.get(o)))
													{
														Count =Count+1;
														for(int p=0;p<MO_Parent.size();p++)
														{
															if(MO_Child.get(o).equals(MO_Parent.get(p)))
															{
																Count =Count+1;
																for(int q=0;q<MO_Parent.size();q++)
																{
																	if(MO_Child.get(p).equals(MO_Parent.get(q)))
																	{
																		Count =Count+1;
																		for(int r=0;r<MO_Parent.size();r++)
																		{
																			if(MO_Child.get(q).equals(MO_Parent.get(r)))
																			{
																				Count =Count+1;
