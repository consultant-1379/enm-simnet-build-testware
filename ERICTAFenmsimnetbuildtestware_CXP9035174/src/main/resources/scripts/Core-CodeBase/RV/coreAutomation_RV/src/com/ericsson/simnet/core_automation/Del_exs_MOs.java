...
public class Del_exs_MOs {
	...
	public void read_all_MOs(String SIM_Name,String[] NE_Names, String initial_kertye, String final_Kertyle, ArrayList<String> MO_Type_generated, ArrayList<Integer> MO_Count_generated, String Logs_File_Name) throws IOException
	{
		...
		System.out.println("the size of MO_Type_generated is "+MO_Type_generated.size());
			...
			for(int j=0;j<Count_MOs.get(i);j++)
			{
				...
				for(k=0;k<all_lines.size();k++)
				{
					...
					else
					{
						...
						System.out.println("cannot able to find out this MO "+Total_MOs.get(i)+" for "+j+"th time");
					}*/
				}
				if(k==all_lines.size())
				{
	...
	public void create_run_del_script(String SIM_Name,int no_of_NEs, String Logs_File_Name) throws IOException
	{
	...
	//	ker_gen.Kertyle_mml(SIM_Name, NE_Names);
		...
		FileWriter fw = new FileWriter(newFile,true);
			System.out.println("INFO: Deleting excess MOs parallely...................");	
