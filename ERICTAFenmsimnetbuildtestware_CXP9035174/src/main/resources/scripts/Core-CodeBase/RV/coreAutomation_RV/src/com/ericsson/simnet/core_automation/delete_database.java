...
public class delete_database {
	 ...
	 public void delete_db(String SIM_Name, String NE_Name)
		...
		try {
		    ...
		    PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("mml_del_db_ne.mml", true))); 
		    ...
		    out.println(".select network");
		    out.println(".start");
		    out.println("dumpmotree:moid=\"1\",ker_out,outputfile=\""+get_addr(NE_Name+"_orig"+".mo")+"\";");
		    out.println(".stop");
