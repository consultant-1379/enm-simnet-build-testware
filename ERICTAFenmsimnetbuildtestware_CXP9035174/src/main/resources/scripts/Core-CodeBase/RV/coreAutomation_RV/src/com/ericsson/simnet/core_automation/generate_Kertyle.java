...
public class generate_Kertyle {
	...
	public int write_lines(String Parent, String MO_Type, int No_of_MOs, int Identity, String File_Name,String Logs_File_Name)
	{
		try {
			PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(File_Name, true)));
			PrintWriter out_logs = new PrintWriter(new BufferedWriter(new FileWriter(Logs_File_Name, true)));
			//System.out.println("Writing KERTYLE Script for  this "+MO_Type+" to populate "+No_of_MOs+" times");
			out_logs.println("Writing KERTYLE Script for  this "+MO_Type+" to populate "+No_of_MOs+" times");
	...
	public void set_mos_kertyle(String mo,ArrayList<String> Attributes, String File_Name,String Logs_File_Name)
	{
			try {
				PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(File_Name, true)));
				PrintWriter out_logs = new PrintWriter(new BufferedWriter(new FileWriter(Logs_File_Name, true)));
