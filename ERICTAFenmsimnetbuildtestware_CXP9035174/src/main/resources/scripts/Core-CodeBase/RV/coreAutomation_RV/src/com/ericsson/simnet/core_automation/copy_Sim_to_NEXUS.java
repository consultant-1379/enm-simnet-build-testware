...
public class copy_Sim_to_NEXUS {
	...
	public void connect_to_Nexus(String SIM_Name, String UserName, String Password, String Version, String Classifier)
	{
		...
		try {
			...
			pw.println("curl -k --upload-file "+FILE+" -u "+UserName+":"+Password+" -v "+NEXUS_Destination_Path+FILE);
			pw.println("if [ $? -eq 0 ]");
			pw.println("then");
