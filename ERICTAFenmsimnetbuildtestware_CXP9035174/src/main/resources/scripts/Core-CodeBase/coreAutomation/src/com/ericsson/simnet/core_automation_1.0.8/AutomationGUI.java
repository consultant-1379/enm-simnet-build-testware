...
public class AutomationGUI {
	...
	String SIM_Name, NODE_Type, Base_Name, MIM_Name, NodeTemplate_Name, Basic_Nodename;
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length != 6) {
			System.out
					.println("Proper Usage is: java -jar Automation.jar <simulationName> <neType> <baseName> <noOfNodes> <BaseTemplate Name> <Basic_Nodename>");
			System.exit(0);
		}
		...
		String NodeTemplate_Name = args[4];
		String Basic_Nodename = args[5];
		...
		try {
			...
			start_process.Automation(SIM_Name, NODE_Type, Base_Name,
					DEFAULT_Destination, NO_of_Nodes, NodeTemplate_Name, Basic_Nodename);
