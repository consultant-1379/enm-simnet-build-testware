...
public class create_NE {
	...
	public void create_ne(String simName, String neName, String neType,
			int numOfNes, String nePort, String neDest, String NodeTemplate_Name, String Basic_Nodename) {
		try {

			PrintWriter out = new PrintWriter(new BufferedWriter(
					new FileWriter("mml_cre_ne.mml", true)));
			numOfNes = numOfNes-1;
			out.println(".open " + NodeTemplate_Name);
			out.println(".saveasimul " + simName);
			out.println(".open " + simName);
			out.println(".selectnocallback " + Basic_Nodename);
			out.println(".clone " + numOfNes + " " + Basic_Nodename + "  2");
			...
			out.println(".rename -auto " + neName + " 01"); 
			out.println(".set save");
