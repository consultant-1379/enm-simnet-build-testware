...
public class Get_Protocol
{
  public String getProtocol(String neType)
  {
    ...
    if ((neType.toLowerCase().contains("ml-tn")) || 
      ...
      (neType.toLowerCase().contains("ml 6366")) ||
      (neType.toLowerCase().contains("ml 6200")) ||
      (neType.toLowerCase().contains("ml 6654")) ||
    ...
    if ((neType.toLowerCase().contains("juniper mx")) ||
       (neType.toLowerCase().contains("juniper vmx")) ||
       (neType.toLowerCase().contains("juniper ptx")) ||
       (neType.toLowerCase().contains("juniper srx")) ||
      (neType.toLowerCase().contains("juniper vsrx")) ||
    ...
    if ((neType.toLowerCase().contains("epg-ssr")) || 
      ...
      (neType.toLowerCase().contains("epg-oi")) ||
      ((neType.toLowerCase().contains("fronthaul")) && 
      (neType.toLowerCase().contains("17b"))) || 
      (neType.toLowerCase().contains("esapc")) ||
      (neType.toLowerCase().contains("vsapc")) ||
      (neType.toLowerCase().contains("scef")) ||
      (neType.toLowerCase().contains("nels")) ||
      (neType.toLowerCase().contains("nsds")) ||
    ...
    if ((neType.toLowerCase().contains("sasn")) ||
      (neType.toLowerCase().contains("eir-fe")) ||
      (neType.toLowerCase().contains("veir-fe")) ||
    ...
    if ((neType.toLowerCase().contains("router 8801")) || 
      ...
      (neType.toLowerCase().contains("scu")) ||
    ...
    if ((neType.toLowerCase().contains("ecm")) ||
       (neType.toLowerCase().contains("hds"))) {
