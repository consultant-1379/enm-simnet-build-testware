...
public class start_Create_Simulation {
	public void Automation(String SIM_Name, String NODE_Type, String Base_Name,
			String DEFAULT_Destination, int No_of_Nodes, String NodeTemplate_Name, String Basic_Nodename)
		...
		System.out.println("\t\t\t\tNo of Nodes                     :      "
				+ No_of_Nodes);
		System.out.println("\t\t\t\tNode Template Name              :      "
				+ NodeTemplate_Name);
		System.out.println("\t\t\t\tBasic Node Name in template     :      "
				+ Basic_Nodename);
		...
		nodeinf.create_ne(SIM_Name, NE_Name, NODE_Type, No_of_Nodes, Port_Name,
				DD_Name, NodeTemplate_Name, Basic_Nodename);
