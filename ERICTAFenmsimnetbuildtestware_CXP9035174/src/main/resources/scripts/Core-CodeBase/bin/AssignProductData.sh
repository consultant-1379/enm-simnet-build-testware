...
elif [[ $simName == *"Spit"* || $simName == *"Router6672"* ||  $simName == *"Router6673"* || $simName == *"Router6675"* || $simName == *"Router6274"* || $simName == *"Router6371"* || $simName == *"Router6273"* ||  $simName == *"Router6676"* || $simName == *"Router6678"* || ( $simName == *"SCU"* && $simName != *"SN-SCU"* ) ]]
then
if [[ $simName == *"SCU"* ]]
then 
mimVersion=SCU`echo $simName | awk -F "SCU" '{print $2}' | awk -F"x" '{print $1}'`
elif [[ $simName == *"Router6672-19"* || $simName == *"Router6675-19"* || $simName == *"Router6274-19"* || $simName == *"Router6371-19"* || $simName == *"Router6672-18"* || $simName == *"Router6675-18"* || $simName == *"Router6274-18"* || $simName == *"Router6371-18"* || $simName == *"Router6672-20"* || $simName == *"Router6675-20"* || $simName == *"Router6274-20"* || $simName == *"Router6371-20"* || $simName == *"Router6273-20"* || $simName == *"Router6673-"* || $simName == *"Router6371-21"* || $simName == *"Router6672-21"* || $simName == *"Router6273-21"* || $simName == *"Router6675-21"* || $simName == *"Router6673-21"* || $simName == *"Router6274-21"* || $simName == *"Router6274-22"* || $simName == *"Router6675-22"* || $simName == *"Router6676-23"* || $simName == *"Router6675-23"* || $simName == *"Router6678-23"* || $simName == *"Router6274-23"* || $simName == *"Router6371-23"* || $simName == *"Router6672-23"* || $simName == *"Router6273-23"* ]]
then
...
then
mimVersion=${tempSimName[a-4]}-${tempSimName[a-3]}-${tempSimName[a-2]}
elif [[ $simName == *"10K-MTAS"* ]]
then
mimVersion=${tempSimName[a-4]}-${tempSimName[a-3]}
elif [[ $simName == *"BSP"* ]] && [[ $simName == *"V"* ]]
then
mimVersion=`echo ${tempSimName[a-3]}-${tempSimName[a-2]}-${tempSimName[a-1]} | awk -F 'x' '{print $1}'`
else
mimVersion=${tempSimName[a-3]}-${tempSimName[a-2]}
fi
