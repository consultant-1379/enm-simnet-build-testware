...
# Purpose     : Loads features for HSS nodes based on node type
...
echo "Example: $0 CORE-ST-vHSS-16A-V3X5  "

}
neType(){

echo "ERROR: The script runs only for HSS nodes"
}
########################################################################
...
/netsim/inst/netsim_pipe < hss.mml
