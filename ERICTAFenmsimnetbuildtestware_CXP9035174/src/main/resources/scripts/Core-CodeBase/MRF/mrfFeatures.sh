...
########################################################################
# Version     : 21.12
# Revision    : CXP 903 5174-1-38
# Purpose     : Adding Brm support
# Description : Sets attributes for Brm MOs
# Date        : Jul 2021
# Who         : zsujmad
########################################################################
########################################################################
...
# Purpose     : Loads features for MRF nodes based on node type
...
echo "Example: $0 CORE-ST-vMRF-16A-V3X5 "

}
neType(){

echo "ERROR: The script runs only for MRF nodes"
}
########################################################################
...
/netsim/inst/netsim_pipe < mrf.mml
