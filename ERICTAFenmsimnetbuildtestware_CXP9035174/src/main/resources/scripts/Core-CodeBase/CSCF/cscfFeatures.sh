...
# Purpose     : Loads features for CSCF nodes based on node type
...
echo "Example: $0 CORE-ST-CSCF-16A-V4x5 "

}
neType(){

echo "ERROR: The script runs only for CSCF nodes"
}
########################################################################
...
/netsim/inst/netsim_pipe < cscf.mml
