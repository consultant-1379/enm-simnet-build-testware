...
SET
(
    mo "ComTop:ManagedElement=$nodeName,BscFunction:BscFunction=1,BscM:BscM=1,BscM:GeranCellM=1,BscM:GeranCell=173027O,BscM:ChannelGroup=0"
    exception none
    nrOfAttributes 2
    "connectedG31Tg" Ref "ManagedElement=$nodeName,BscFunction=1,BscM=1,Bts=1,G31Tg=1"
    "connectedG12Tg" Ref "ManagedElement=$nodeName,BscFunction=1,BscM=1,Bts=1,G12Tg=189"
)
SET
(
    mo "ComTop:ManagedElement=$nodeName,BscFunction:BscFunction=1,BscM:BscM=1,BscM:GeranCellM=1,BscM:GeranCell=173027O,BscM:ChannelGroup=1"
    exception none
    nrOfAttributes 2
    "connectedG31Tg" Ref "ManagedElement=$nodeName,BscFunction=1,BscM=1,Bts=1,G31Tg=1"
    "connectedG12Tg" Ref "ManagedElement=$nodeName,BscFunction=1,BscM=1,Bts=1,G12Tg=189"
...
/netsim/inst/netsim_pipe < excep.mml
for filenum in ${moFiles[@]}
do
rm $filenum
done
rm bsc.mml excep.mml *.txt
